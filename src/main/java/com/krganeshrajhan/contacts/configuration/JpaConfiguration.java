package com.krganeshrajhan.contacts.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.krganeshrajhan.contacts.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.krganeshrajhan.contacts.model" });
